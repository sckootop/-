...
void ASCharacter::PrimaryAttack()
{
	if (canPrimaryAttack == true) {
		...
		GetWorldTimerManager().SetTimer(TimerHandle_PrimaryAttack, this, &ASCharacter::SetcanPrimaryAttack, PrimaryAttack_CD, false);
	}
}

void ASCharacter::SetcanPrimaryAttack()
{
